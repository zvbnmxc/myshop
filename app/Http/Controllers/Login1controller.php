...
class Login1Controller extends Controller
{
    public function select()
    {
        ...
        // dd($zhucInfo);
        return view('login1.select',['zhucInfo'=>$zhucInfo]);
    }
    //注册视图
    public function add(){
        return view('login1.che');
    }
    //执行添加
    public function doadd(Request $request)
    {
        ...
        // dd($res);
        if($res){
            return redirect('login11/index');
        }
    }
    //登录视图
    public function kong(Request $request)
    {
        return view('login1.index');
    }
    //执行登录
    public function store(Request $request)
    {
        ...
        // return redirect('login1/zhanshi');
    }
    //展示
    ...
    { 
        ...
        return view('login1/zhanshi',['data'=>$data,'admin_name'=>$req['admin_name']]);
    }
}
